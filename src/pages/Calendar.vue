  ...
  <q-page class="q-pa-sm bg-white">
    <div class="row q-col-gutter-md">
      <div class="col-lg-3 col-md-3">
        <div class="row">
          <q-date v-model="selectedDateForQDate"
                  minimal
                  class="col"
      ...
      <div class="col-lg-9 col-md-9">
        <div>
          <q-banner inline-actions
            ...
            <span class="text-bold">Desk 65</span>
            <template v-slot:action>
              <q-select v-model="calendarView"
                        ...
                        style="min-width: 120px; background: transparent; color: white"></q-select>
            </template>

          </q-banner>
          <q-calendar class="q-mt-sm"
